...
class Bbs extends CI_Controller
{
    ...
    public function login()
    {
        if (!empty($_SESSION['admin_login'])) {
            header('location: /codeigniter/bbs/admin');
            exit();
        }
        $this->load->view('header_view');
    ...
    public function logout()
    {
        ...
        header('location: /codeigniter/bbs/login');
        exit();
    }
    ...
    public function edit()
    {
        if (!empty($_SESSION['admin_login'])) {
            ...
            if (!empty($id) && is_numeric($id)) {
                ...
                header('location: /codeigiter/bbs/admin');
                exit();
            }
        } else {
            header('location: /codeigniter/bbs/login');
    ...
    public function add_bbs()
    {
        ...
        header('location: /codeigniter/bbs/index');
        exit();
    }
        ...
        if (!empty($this->input->post('message_id', true))) {
            ...
            if (empty($error_message)) {
                ...
                if ($this->Bbs_model->update_row($id, $data)) {
                    ...
                    header("location: /codeigniter/bbs/edit?message_id={$id}");
                }
            } else {
                $_SESSION['error_message'] = $error_message;
                header("location: /codeigniter/bbs/edit?message_id={$id}");
    ...
    public function delete_bbs()
    {
        if (!empty($id = $this->input->post('message_id', true))) {
            ...
            if ($this->Bbs_model->delete_row($id)) {
                ...
                header("location: /codeigniter/bbs/delete?message_id={$id}");
                exit();
            }
        } else {
